...
public class A3
{
	...
	public A3(final String[] args)
	{
		...
		this.setWindow(new ApplicationWindow(null, "Rectangle Application", new Dimension(800, 600), this.isDebugging(), true, myActionPerformed,
			myDrawGUI));
	}
	...
	public void printRectangle()
	{
		...
		if ((!isHeightEmpty) && (!isWidthEmpty))
		{
			...
			if (Support.isStringParsedAsDouble((String)cboHeight.getSelectedItem()) &&
				Support.isStringParsedAsDouble((String)cboWidth.getSelectedItem()))
			{
				...
				this.getOutput().append(Color.GREEN, Color.WHITE, "[" + Support.getDateTimeStamp() + "] ", 
