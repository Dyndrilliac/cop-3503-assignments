...
public class A2
{
    ...
    protected static void problem23(final RichTextPane rtpOutput, final int problemArg)
    {
        ...
        rtpOutput.append(Color.BLACK,
            Color.WHITE,
            "\tAnswer (Left-to-Right): " + ltrSum + "\n",
            Color.BLACK,
            Color.WHITE,
            "\tAnswer (Right-to-Left): " + rtlSum + "\n\n");
    }
    ...
    protected static void problem25(final RichTextPane rtpOutput, final int problemArg)
    {
        ...
        /*
         * Summing the Leibniz series yields the same value as arctan(1), which is pi/4. Therefore to get pi we have to multiply the sum by 4. This
         * series converges very slowly. You can only accurately calculate pi to many digits with a very large number of iterations. As the number of
         * iterations approaches positive infinity, the answer becomes more accurate.
         */
