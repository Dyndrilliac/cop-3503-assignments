...
public class A1
{
    ...
    {
        String employeeName = Support.getInputString(this.getWindow(), "Please enter this employee's name:", "Input Employee Name");
        ...
        do
        {
            payRate = Support.getDoubleInputString(this.getWindow(), "Please enter this employee's hourly pay rate:", "Input Pay Rate");
        }
        while (payRate == 0);
        
        do
        {
            fedTaxRate = Support.getDoubleInputString(this.getWindow(), "Please enter the Federal income tax rate:", "Input Federal Tax Rate");
        }
        while (fedTaxRate == 0);
        
        do
        {
            stateTaxRate = Support.getDoubleInputString(this.getWindow(), "Please enter the State income tax rate:", "Input State Tax Rate");
        }
    ...
    protected void showOutput(final String employeeName,
        final double hoursWorked,
        final double payRate,
        final double fedTaxRate,
        final double stateTaxRate)
    {
        ...
        this.getOutput().append(Color.BLACK,
            ...
            Color.BLACK,
            Color.WHITE,
            "Hours Worked:  " + Double.valueOf(twoDecimalPlaces.format(hoursWorked)) + "\n",
            Color.BLACK,
            Color.WHITE,
            "Pay Rate:  $" + Double.valueOf(twoDecimalPlaces.format(payRate)) + "\n",
            Color.BLACK,
            Color.WHITE,
            "Gross Pay:  $" + Double.valueOf(twoDecimalPlaces.format(grossPay)) + "\n",
            Color.RED,
            Color.WHITE,
            "Deductions:\n",
            Color.RED,
            Color.WHITE,
            "\tFederal Withholding (" + Double.valueOf(twoDecimalPlaces.format((fedTaxRate * 100))) +
                "%):  $" +
                Double.valueOf(twoDecimalPlaces.format((fedTaxRate * grossPay))) +
                "\n",
            Color.RED,
            Color.WHITE,
            "\tState Withholding (" + Double.valueOf(twoDecimalPlaces.format((stateTaxRate * 100))) +
                "%):  $" +
                Double.valueOf(twoDecimalPlaces.format((stateTaxRate * grossPay))) +
                "\n",
            Color.RED,
            Color.WHITE,
            "\tTotal Deduction:  $" + Double.valueOf(twoDecimalPlaces.format(totalDeduction)) + "\n",
            Color.BLACK,
            Color.WHITE,
            "Net Pay:  $" + Double.valueOf(twoDecimalPlaces.format(netPay)) + "\n\n");
    }
}